...
\begin{frame}{Μνήμη ακολουθιών}
  ...
  \begin{columns}[T]
    ...
    \begin{block}{Μεταβλητές κατάστασης}
      \begin{description}
        \item[$D_d$] $∈ 𝕊𝕢^{\mathit{Nₙ×Nₛ}}$: πίνακας συναπτικών μονιμοτήτων
        \item[$\mathit{NS}$] $∈ 𝔹^{\mathit{Nₙ×Nₛ}}$: πίνακας γειτνίασης νευρώνων - δενδριτών
        \item[$\mathit{SC}$] $∈ 𝔹^{\mathit{Nₛ×Nc}}$: πίνακας γειτνίασης δενδριτών - μικροστηλών
      \end{description}
    \end{block}
  \end{columns}
  }
